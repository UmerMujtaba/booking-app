    ...
    return (
      <View style={[styles.container, { backgroundColor: colors.background }]}>
        ...
        <Text style={[styles.body, { color: colors.mutedForeground, fontFamily: 'Inter_400Regular' }]}>
          Your account was created but the database schema hasn't been applied yet.
        </Text>
        <View style={[styles.stepBox, { backgroundColor: colors.card, borderColor: colors.border }]}>
          ...
          <Text style={[styles.step, { color: colors.mutedForeground, fontFamily: 'Inter_400Regular' }]}>
        ...
        <Pressable style={styles.signOutLink} onPress={signOut}>
          <Text style={[styles.signOutText, { color: colors.mutedForeground, fontFamily: 'Inter_400Regular' }]}>
...
const styles = StyleSheet.create({
  ...
  stepBox: { borderRadius: 14, borderWidth: 1, padding: 18, gap: 10, width: '100%' },
